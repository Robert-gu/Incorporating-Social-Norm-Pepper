...
def main(session):
    ...
    time.sleep(1)
    asr_service.say("Nice to meet you. ^start(animations/Stand/Gestures/CalmDown_1) Do you need any help?", configuration)
    time.sleep(1)
    motion_service.moveTo(1, 0, 0)
    time.sleep(1)
    asr_service.say("To access more information. ^start(animations/Stand/Gestures/ShowTablet_2) Please check my tablet ", configuration)
    time.sleep(1)
